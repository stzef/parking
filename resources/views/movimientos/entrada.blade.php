                ...
                <form @submit.prevent="CreateEntrada" accept-charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-md-offset-1">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="placa" class="form-control placa" v-model="entrada.placa" @change="GenInTime()" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12">
                                <select-tariff id="ctarifa" requeried="true" :tarifas="tarifas" :obj="entrada"></select-tariff>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="" class="label-control col-md-12 text-center">Tipo de vehiculo</label>
                            <div class="col-md-12">
                                <select-tyve id="ctipov" requeried="true" :tipovehiculo="tipovehiculo" :obj="entrada"></select-tyve>
                            </div>
                        </div>
                    </div>
